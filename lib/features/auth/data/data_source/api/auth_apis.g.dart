...
class _AuthApis implements AuthApis {
  _AuthApis(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<AuthResponseModel> login(Map<String, dynamic> map) async {
  ...
  @override
  Future<AuthResponseModel> signup(UserModel user) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
